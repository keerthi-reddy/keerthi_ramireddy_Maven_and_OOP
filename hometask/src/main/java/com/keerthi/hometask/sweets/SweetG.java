...
public class SweetG implements com.keerthi.hometask.sweets.Generator<Sweet>, Iterable<Sweet> {
    ...
    private Sweet[] instances = {new darkchocolate(), new doodhpeda(),
            new kajubarfi(), new whitechocolate()   };
    public Sweet next() {
        try {
